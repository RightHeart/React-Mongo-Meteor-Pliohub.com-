...
$globalObject->htmlCloseHeadStartBody("$xBODY_PADDING_DEFAULT_EXTERNAL $BODY_PLAIN_BG_DEFAULT_EXTERNAL $BODY_IMG_BG_DEFAULT_EXTERNAL"," onload=\"document.formVlogin1.xusername.focus();\""); // </head> <body class='' attribute=''>
//$highlightRightMenu=FALSE;
...
include("includes/navbarSettings1.php");
