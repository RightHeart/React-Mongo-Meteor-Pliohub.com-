<?php
// $photoFileName, $photoFileCaption are needed to use this file
...
";
for($i=0;$i<count($photoFileName);$i++){
echo "tooltips[$i]=[\"$photoFileName[$i]\", \"$photoFileCaption[$i]\", {background:\"white\", font:\"bold 12px Arial\"}]\n";
}
